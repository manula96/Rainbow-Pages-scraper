...
def parse_listing(keyword, place):
    print("Enter number of result pages for your search")
    page = input()
    ...
    for page in range (1, page+1):
        ...
        url = "https://rainbowpages.lk/search.php?page={0}&s={1}&l={2}&".format(page, keyword, place)
        ...
        print("Couldn't scrape all pages")